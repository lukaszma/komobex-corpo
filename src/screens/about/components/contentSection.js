    ...
    <div className="container">
      <div className="row">
        <div className="col-sm-6">
          <img
            src="../../../img-content-04.jpg"
            className="img-responsive cast-shadow"
          />
        </div>
        <div className="col-md-4 col-md-offset-1 col-sm-5 col-sm-offset-1 padd-40-top">
          <p>
            ...
            perfekcji nadal jesteśmy w stanie sprostać oczekiwaniom inwestorów w
            takim samym stopniu.
          </p>
        </div>
      </div>
      <div className="row">
        <div className="col-md-4 col-md-offset-1 col-sm-5 col-sm-offset-1 padd-40-top">
          <p>
            ...
            naszych Klientów. Wyspecjalizowana kadra z różnych dziedzin, licząca
            ponad 150 pracowników oraz rozbudowany park maszynowy pozwala na
            wykonanie największych i najbardziej zaawansowanych technologicznie
            inwestycji.
          </p>
        </div>
        <div className="col-sm-6">
      ...
      <div className="row">
        <div className="col-md-4 col-md-offset-1 col-sm-5 col-sm-offset-1 padd-40-top">
          ...
          <p>
            ...
            pozycji na rynku oraz przeświadczeniu o priorytetowej roli jakości w
            aspekcie funkcjonowania organizacji, relacji z Klientami oraz
